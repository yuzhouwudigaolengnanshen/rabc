...
insert into rbac_user(id,username,password,org_id,org_ids) values(1,'admin','202cb962ac59075b964b07152d234b70',0,'0,1,2,3,4,5,6,7,11,12,13,21,22,23,31,32,33,41,42,43,44,51,52,53,61,62,63,64,71,72,73,111,112,113,131,132,133');
insert into rbac_user(id,username,password,org_id,org_ids) values(2,'赵总','202cb962ac59075b964b07152d234b70',1,'0,1,11,12,13,111,112,113,131,132,133');
insert into rbac_user(id,username,password,org_id,org_ids) values(3,'钱总','202cb962ac59075b964b07152d234b70',11,'0,1,11,111,112,113');
insert into rbac_user(id,username,password,org_id,org_ids) values(4,'孙经理','202cb962ac59075b964b07152d234b70',111,'0,1,11,111');
insert into rbac_user(id,username,password,org_id,org_ids) values(5,'李经理','202cb962ac59075b964b07152d234b70',112,'0,1,11,112');
insert into rbac_user(id,username,password,org_id,org_ids) values(6,'周经理','202cb962ac59075b964b07152d234b70',113,'0,1,11,113');
insert into rbac_user(id,username,password,org_id,org_ids) values(7,'小吴','202cb962ac59075b964b07152d234b70',111,'0,1,11,111');
insert into rbac_user(id,username,password,org_id,org_ids) values(8,'小郑','202cb962ac59075b964b07152d234b70',112,'0,1,11,112');
insert into rbac_user(id,username,password,org_id,org_ids) values(9,'小王','202cb962ac59075b964b07152d234b70',113,'0,1,11,113');
insert into rbac_user(id,username,password,org_id,org_ids) values(10,'小冯','202cb962ac59075b964b07152d234b70',111,'0,1,11,111');
insert into rbac_user(id,username,password,org_id,org_ids) values(11,'小陈','202cb962ac59075b964b07152d234b70',112,'0,1,11,112');
insert into rbac_user(id,username,password,org_id,org_ids) values(12,'小褚','202cb962ac59075b964b07152d234b70',113,'0,1,11,113');
insert into rbac_user(id,username,password,org_id,org_ids) values(13,'小魏','202cb962ac59075b964b07152d234b70',111,'0,1,11,111');
insert into rbac_user(id,username,password,org_id,org_ids) values(14,'小蒋','202cb962ac59075b964b07152d234b70',112,'0,1,11,112');
insert into rbac_user(id,username,password,org_id,org_ids) values(15,'小沈','202cb962ac59075b964b07152d234b70',113,'0,1,11,113');
--insert into rbac_user(id,username,password) values(16,'小韩','202cb962ac59075b964b07152d234b70');
--insert into rbac_user(id,username,password) values(17,'小杨','202cb962ac59075b964b07152d234b70');
...
insert into rbac_module(id,name,pid,code) values(13,'用户管理',1,'/system/user'); -- /system/user/page /system/user/toadd
...
insert into rbac_role_module(role_id,module_id) values(1,1);
...
insert into rbac_role_module(role_id,module_id) values(3,3);
...
insert into rbac_role_module(role_id,module_id) values(4,2);
...
insert into rbac_role_module(role_id,module_id) values(5,3);
